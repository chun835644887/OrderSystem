...
public class OrderStatusActivity extends HorizontalActivity implements Runnable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent=new Intent(OrderStatusActivity.this,OrderStatusItemActivity.class);
...
Handler handler=new Handler(){
	public void handleMessage(android.os.Message msg) {
		switch (msg.what) {
		case 0:
			orderStatusAdapter=new OrderStatusAdapter(OrderStatusActivity.this, list);
			Log.i("tag",list.get(0).getNum());
